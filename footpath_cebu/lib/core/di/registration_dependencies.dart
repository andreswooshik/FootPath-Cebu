...
import 'package:footpath_cebu/data/repositories/api_coordinator_people_repository.dart';
...
import 'package:footpath_cebu/data/repositories/mock_coordinator_people_repository.dart';
...
final clubMemberRepositoryProvider = Provider<ClubMemberRepository>(
  (ref) => useMockData
      ? ref.watch(mockClubMemberRepositoryProvider)
      : ApiClubMemberRepository(),
);

final coordinatorPeopleRepositoryProvider =
    Provider<CoordinatorPeopleRepository>(
      (ref) => useMockData
          ? MockCoordinatorPeopleRepository(
              ref.watch(mockClubMemberRepositoryProvider),
              ref.watch(playerRepositoryProvider) as MockPlayerRepository,
            )
          : ApiCoordinatorPeopleRepository(),
    );
