...
class ServiceLocator {
  ...
  static void initMock() => _wire(MockAuthRepository(), MockPlayerRepository());

  /// Live Firebase auth + Django REST repositories.
  static void initFirebase() =>
      _wire(FirebaseAuthRepository(), ApiPlayerRepository());

  static void _wire(AuthRepository auth, PlayerRepository players) {
    signIn = SignIn(auth);
