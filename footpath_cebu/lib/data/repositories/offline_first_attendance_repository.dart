...
class OfflineFirstAttendanceRepository
  ...
  Future<PageSlice<Attendance>> fetchAttendancePageForPlayer(
    ...
    final inner = _inner;
    if (inner is PlayerAttendancePageReader) {
      return (inner as PlayerAttendancePageReader).fetchAttendancePageForPlayer(
        playerId,
        offset: offset,
        limit: limit,
    ...
    final records = await inner.fetchAttendanceForPlayer(
      playerId,
      unlockToken: unlockToken,
    );
